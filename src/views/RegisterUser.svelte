...
<svelte:head>
    ...
    <!-- Layout config Js -->
    <script defer src="http://localhost:5173/src/assets/js/layout.js"></script>
    <!-- Bootstrap Css -->
    <link
    ...
    <!-- Js tempalte -->
    <!-- ============================================ -->
    <script defer src="http://localhost:5173/src/assets/libs/bootstrap/js/bootstrap.bundle.min.js"></script>
    <script defer src="http://localhost:5173/src/assets/libs/simplebar/simplebar.min.js"></script>
    <script defer src="http://localhost:5173/src/assets/libs/node-waves/waves.min.js"></script>
    <script defer src="http://localhost:5173/src/assets/libs/feather-icons/feather.min.js"></script>
    <script defer src="http://localhost:5173/src/assets/js/pages/plugins/lord-icon-2.1.0.js"></script>
    <script defer src="http://localhost:5173/src/assets/js/plugins.js"></script>

    <!-- particles js -->
    <script defer src="http://localhost:5173/src/assets/libs/particles.js/particles.js"></script>
    <!-- particles app js -->
    <script defer src="http://localhost:5173/src/assets/js/pages/particles.app.js"></script>
    <!-- validation init -->
    <script defer src="http://localhost:5173/src/assets/js/pages/form-validation.init.js"></script>
    <!-- password create init -->
    <script defer src="http://localhost:5173/src/assets/js/pages/passowrd-create.init.js"></script>
                        ...
                        <div class="text-center mt-sm-5 mb-4 text-white-50">
                            <div>
                                <a href="index.html" class="d-inline-block auth-logo">
                                    <img src="http://localhost:5173/src/assets/images/logo-light.png" alt="" height="20">
                                </a>
                            </div>
