...
<svelte:head>
   ...
   <!--Swiper slider css-->
   <link
      href="http://localhost:5173/src/assets/libs/swiper/swiper-bundle.min.css"
      rel="stylesheet"
      type="text/css" />
               ...
               <div class="container-fluid">
                  ...
                  <div class="row">
                                                                     ...
                                                                     <div
                                                                        ...
                                                                        <div
                                                                           ...
                                                                           <div
                                                                              class="profile-user position-relative d-inline-block mx-auto  mb-4">
                                                                              <img
                                                                                 src="http://localhost:5173/src/assets/images/users/user-dummy-img.jpg"
                                                                                 class="rounded-circle avatar-xl img-thumbnail user-profile-image  shadow"
                                                                                 alt="user-profile" />
                                                                              <div
                                                                                 class="avatar-xs p-0 rounded-circle profile-photo-edit">
                     ...
                     <div>
                        ...
                        <!--Swiper slider js-->
                        <script
                           src="http://localhost:5173/src/assets/libs/swiper/swiper-bundle.min.js"></script>

                        <!-- ecommerce product details init -->
                        <script
                           src="http://localhost:5173/src/assets/js/pages/ecommerce-product-details.init.js"></script>
