    ...
    <main>
        ...
        <div id="layout-wrapper">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="card-body p-4">
                                        <div class="text-center">
                                            ...
                                            >
                                                <img
                                                    src="http://localhost:5173/src/assets/images/users/avatar-1.jpg"
            ...
            <div>
                ...
                <!-- JAVASCRIPT -->
                <script
                    src="http://localhost:5173/src/assets/libs/bootstrap/js/bootstrap.bundle.min.js"
                ></script>
                <script
                    src="http://localhost:5173/src/assets/libs/simplebar/simplebar.min.js"
                ></script>
                <script
                    src="http://localhost:5173/src/assets/libs/node-waves/waves.min.js"
                ></script>
                <script
                    src="http://localhost:5173/src/assets/libs/feather-icons/feather.min.js"
                ></script>
                <script
                    src="http://localhost:5173/src/assets/js/pages/plugins/lord-icon-2.1.0.js"
                ></script>
                <script src="http://localhost:5173/src/assets/js/plugins.js"></script>
                <!-- prismjs plugin -->
                <script
                    src="http://localhost:5173/src/assets/libs/prismjs/prism.js"
                ></script>
                <script
                    src="http://localhost:5173/src/assets/libs/list.js/list.min.js"
                ></script>
                <script
                    src="http://localhost:5173/src/assets/libs/list.pagination.js/list.pagination.min.js"
                ></script>

                <!-- listjs init -->
                <script
                    src="http://localhost:5173/src/assets/js/pages/listjs.init.js"
                ></script>

                <!-- Sweet Alerts js -->
                <script
                    src="http://localhost:5173/src/assets/libs/sweetalert2/sweetalert2.min.js"
                ></script>
