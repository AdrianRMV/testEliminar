...
<svelte:head>
   ...
   <!-- Sweet Alert css-->
   <link
      href="http://localhost:5173/src/assets/libs/sweetalert2/sweetalert2.min.css"
      rel="stylesheet"
      type="text/css" />
   <!-- One of the following themes -->
   <link
      rel="stylesheet"
      href="http://localhost:5173/src/assets/libs/%40simonwep/pickr/themes/classic.min.css" />
   <!-- 'classic' theme -->
   <link
      rel="stylesheet"
      href="http://localhost:5173/src/assets/libs/%40simonwep/pickr/themes/monolith.min.css" />
   <!-- 'monolith' theme -->
   <link
      rel="stylesheet"
      href="http://localhost:5173/src/assets/libs/%40simonwep/pickr/themes/nano.min.css" />
   <!-- 'nano' theme -->
   ...
   <!-- Bootstrap Css -->
   <link
      href="http://localhost:5173/src/assets/css/bootstrap.min.css"
      rel="stylesheet"
      type="text/css" />
   <!-- Icons Css -->
   <link
      href="http://localhost:5173/src/assets/css/icons.min.css"
      rel="stylesheet"
      type="text/css" />
   <!-- App Css-->
   <link
      href="http://localhost:5173/src/assets/css/app.min.css"
      rel="stylesheet"
      type="text/css" />
   <!-- custom Css-->
   <link
      href="http://localhost:5173/src/assets/css/custom.min.css"
      rel="stylesheet"
      type="text/css" />
</svelte:head>
   ...
   <main>
      ...
      <div id="layout-wrapper">
         ...
         <div>
            ...
            <!-- JAVASCRIPT -->
            <script
               src="http://localhost:5173/src/assets/libs/bootstrap/js/bootstrap.bundle.min.js"></script>
            <script
               src="http://localhost:5173/src/assets/libs/simplebar/simplebar.min.js"></script>
            <script
               src="http://localhost:5173/src/assets/libs/node-waves/waves.min.js"></script>
            <script
               src="http://localhost:5173/src/assets/libs/feather-icons/feather.min.js"></script>
            <script
               src="http://localhost:5173/src/assets/js/pages/plugins/lord-icon-2.1.0.js"></script>
            ...
            <script
               src="http://localhost:5173/src/assets/libs/list.js/list.min.js"></script>
            <script
               src="http://localhost:5173/src/assets/libs/list.pagination.js/list.pagination.min.js"></script>

            <!-- listjs init -->
            <script
               src="http://localhost:5173/src/assets/js/pages/listjs.init.js"></script>

            <!-- Sweet Alerts js -->
            <script
               src="http://localhost:5173/src/assets/libs/sweetalert2/sweetalert2.min.js"></script>

            <!-- Modern colorpicker bundle -->
            <script
               src="http://localhost:5173/src/assets/libs/%40simonwep/pickr/pickr.min.js"></script>

            <!-- init js -->
            <script
               src="http://localhost:5173/src/assets/js/pages/form-pickers.init.js"></script>
