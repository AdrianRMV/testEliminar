                     ...
                     <div class="row" id="contactList">
                        <div class="col-lg-12">
                           ...
                           <div>
                              ...
                              <script
                                 src="http://localhost:5173/src/assets/js/plugins.js"></script>
                              <!-- prismjs plugin -->
                              <script
                              ...
                              <!--crypto-orders init-->
                              <script
                                 src="http://localhost:5173/src/assets/js/pages/crypto-orders.init.js"></script>

                              <!-- App js -->
                              <script
                                 src="http://localhost:5173/src/assets/js/app.js"></script>
                           </div>
                        </div>
                     </div>
                  </div>
